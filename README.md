...
<p>
  <a aria-label="NPM version" href="https://www.npmjs.com/package/@zitterorg/commodi-eum">
    <img alt="" src="https://img.shields.io/npm/v/@zitterorg/commodi-eum.svg?style=for-the-badge&labelColor=0869B8">
  </a>
  <a aria-label="License" href="#">
    <img alt="" src="https://img.shields.io/npm/l/@zitterorg/commodi-eum.svg?style=for-the-badge&labelColor=579805">
  </a>
  <a aria-label="Thinkmill Logo" href="https://www.thinkmill.com.au/open-source?utm_campaign=github-@zitterorg/commodi-eum">
...
There is also a [Changelog](https://github.com/zitterorg/commodi-eum/blob/master/HISTORY.md).
...
```js
import React, { useState } from 'react';
import classNames from '@zitterorg/commodi-eum';
...
```js
const classNames = require('@zitterorg/commodi-eum/dedupe');
...
```js
const classNames = require('@zitterorg/commodi-eum/bind');
...
import classNames from '@zitterorg/commodi-eum/bind';
